...
# Aktifkan server mini agar Replit tetap hidup
keep_alive()

# GANTI dengan token bot Telegram kamu
TOKEN = "7875159098:AAHA17VazBaHRLrZ3zaO_Yjic0tD6rAnMVI"

# Waktu alert harian (WITA)
ALERT_TIMES = ["09:00", "18:00"]
...
def start(update, context):
    ...
    context.bot.send_message(chat_id=chat_id, text="Bot aktif ✅\nKamu akan menerima notifikasi harga Cardano (ADA) setiap hari jam 09:00 & 18:00 WITA.")
